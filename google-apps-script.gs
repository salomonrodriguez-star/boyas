/**
 * SEMEX - Boyas Landing | Google Apps Script
 * Recibe POST con JSON desde la landing y lo guarda en la hoja activa.
 *
 * CÓMO USAR:
 * 1. Crea un Google Sheet nuevo (ej. "Cotizaciones Boyas").
...
function doPost(e) {
  try {
    ...
    // MailApp.sendEmail({
    //   to: TU_CORREO,
    //   subject: "Nueva cotización - Boyas",
...
function doGet() {
  return ContentService
    .createTextOutput("OK - SEMEX Boyas form handler online")
